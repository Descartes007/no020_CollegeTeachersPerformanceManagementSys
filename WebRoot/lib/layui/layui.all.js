            ...
            (e = e
                ...
                .replace(c.query(1), function (e) {
                    ...
                    return e.replace(/\s/g, "") === r.open + r.close
                        ? ""
                        : ((e = e.replace(n(r.open + "|" + r.close), "")), /^=/.test(e) && ((e = e.replace(/^=/, "")), (c = '"+_escape_(')), c + e.replace(/\\/g, "") + ')+"');
                })),
                        ...
                        "function" == typeof a &&
                            !(function c() {
                                return ++d > 80
                                    ...
                                    : void (1989 === parseInt(t.getStyle(document.getElementById(l), "width")) ? a() : setTimeout(c, 100));
                            })();
                }
            },
        },
            ...
            if (((r = { year: 0 | r[0], month: (0 | r[1]) - 1, date: 0 | r[2] }), !e.hasClass(s)))
                if (n.range) {
                    if (
                        ...
                        if (
                            (e.addClass(o), t.endDate ? w.extend(t.endDate, r) : (t.endDate = w.extend({}, r, t.endTime)), t.newDate(r).getTime() < t.newDate(t.startYMD).getTime())
                        ) {
...
!(function (e, t) {
        ...
        (pe.extend = pe.fn.extend =
            function () {
                var e,
                    ...
                    l = !1;
                for (
                    "boolean" == typeof a && ((l = a), (a = arguments[s] || {}), s++), "object" == typeof a || pe.isFunction(a) || (a = {}), s === u && ((a = this), s--);
                    s < u;
                    s++
                )
                    ...
                    preFilter: {
                        ...
                        PSEUDO: function (e) {
                            ...
                            return pe.CHILD.test(e[0])
                                ...
                                : (e[3]
                                      ? (e[2] = e[4] || e[5] || "")
                                      : n && fe.test(n) && (t = N(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && ((e[0] = e[0].slice(0, t)), (e[2] = n.slice(0, t))),
                                  e.slice(0, 3));
                        },
                    },
                    filter: {
                                          ...
                                          if (((h = [a ? m.firstChild : m.lastChild]), a && v)) {
                                              ...
                                              for (
                                                  ...
                                                  ((s ? d.nodeName.toLowerCase() !== y : 1 !== d.nodeType) ||
                                                      !++x ||
                                                      (v && ((f = d[P] || (d[P] = {})), (c = f[d.uniqueID] || (f[d.uniqueID] = {})), (c[e] = [W, x])), d !== t));
        ...
        pe.extend({
            ...
            ready: function (e) {
                (e === !0 ? --pe.readyWait : pe.isReady) ||
                    ((pe.isReady = !0),
                    (e !== !0 && --pe.readyWait > 0) || (je.resolveWith(re, [pe]), pe.fn.triggerHandler && (pe(re).triggerHandler("ready"), pe(re).off("ready"))));
            },
        }),
    ...
    (pe.event = {
        ...
        fix: function (e) {
            ...
            for (
                ...
                (n = r[t]), (e[n] = o[n]);
            return (
                e.target || (e.target = o.srcElement || re), 3 === e.target.nodeType && (e.target = e.target.parentNode), (e.metaKey = !!e.metaKey), a.filter ? a.filter(e, o) : e
            );
        },
        ...
        fe.opacity ||
            (pe.cssHooks.opacity = {
                ...
                set: function (e, t) {
                    ...
                    (n.zoom = 1),
                        ((t >= 1 || "" === t) && "" === pe.trim(o.replace(yt, "")) && n.removeAttribute && (n.removeAttribute("filter"), "" === t || (r && !r.filter))) ||
    ...
    pe.fn.extend({
        ...
        (Ht = {
            set: function (e, t, n) {
                return (
                    t === !1 ? pe.removeAttr(e, n) : (Mt && Ft) || !_t.test(n) ? e.setAttribute((!Ft && pe.propFix[n]) || n, n) : (e[pe.camelCase("default-" + n)] = e[n] = !0), n
                );
            },
        }),
            ...
            return "boolean" == typeof t && "string" === n
                ...
                : this.each(function () {
                      ...
                      if ("string" === n) for (r = 0, i = pe(this), o = e.match(De) || []; (t = o[r++]); ) i.hasClass(t) ? i.removeClass(t) : i.addClass(t);
                          ...
                          (void 0 !== e && "boolean" !== n) ||
                              ((t = z(this)), t && pe._data(this, "__className__", t), pe.attr(this, "class", t || e === !1 ? "" : pe._data(this, "__className__") || ""));
                  });
        },
        hasClass: function (e) {
            var t,
    ...
    pe.extend({
        ...
        pe.each(["get", "post"], function (e, t) {
            pe[t] = function (e, n, r, i) {
                return (
                    pe.isFunction(n) && ((i = i || r), (r = n), (n = void 0)), pe.ajax(pe.extend({ url: e, type: t, dataType: i, data: n, success: r }, pe.isPlainObject(e) && e))
                );
            };
        }),
    ...
    pe.ajaxSetup({
        ...
        pe.ajaxPrefilter("json jsonp", function (t, n, r) {
            var i,
                ...
                s =
                    t.jsonp !== !1 &&
                    (dn.test(t.url) ? "url" : "string" == typeof t.data && 0 === (t.contentType || "").indexOf("application/x-www-form-urlencoded") && dn.test(t.data) && "data");
        ...
        f = {
            ...
            clickThis: function () {
                ...
                ("javascript:;" !== t.attr("href") && "_blank" === t.attr("target")) || y || c[0] || (i.find("." + l).removeClass(l), s.addClass(l)),
                    i.hasClass(u) &&
                        (c.removeClass(h),
                        c[0] && (s["none" === c.css("display") ? "addClass" : "removeClass"](r + "ed"), "all" === i.attr("lay-shrink") && s.siblings().removeClass(r + "ed"))),
                                            ...
                                            .on("keydown", function (e) {
                                                ...
                                                var i = function (t, a) {
                                                    ...
                                                    return (
                                                        ...
                                                        (n = r[t]("dd:not(." + o + ")")),
                                                        l[0]
                                                            ? ((y = r[t]()), (n[0] && !n.hasClass(c)) || !y[0] ? (n.addClass(s).siblings().removeClass(s), void $()) : i(t, y))
                                                            : (y = null)
                                                    );
                                                };
                                    ...
                                    return (
                                        "tips" === u
                                            ? i.tips(
                                                  f,
                                                  (function () {
                                                      return "string" == typeof r.attr("lay-ignore") || ("select" !== l.tagName.toLowerCase() && !/^checkbox|radio$/.test(l.type))
                                                          ? r
                                                          : r.next();
                                                  })(),
                                                  { tips: 1 }
                ...
                var l = n.children && n.children.length > 0,
                    ...
                    s = o(
                        [
                            ...
                            (function () {
                                return r.check
                                    ? '<i class="layui-icon layui-tree-check">' + ("checkbox" === r.check ? t.checkbox[0] : "radio" === r.check ? t.radio[0] : "") + "</i>"
                                    : "";
                            })(),
                            (function () {
                                return (
...
layui.define(["laytpl", "laypage", "layer", "form", "util"], function (e) {
    ...
    (F.prototype.config = { limit: 10, loading: !0, cellMinWidth: 60, defaultToolbar: ["filter", "exports", "print"], autoSort: !0, text: { none: "无数据" } }),
        (F.prototype.render = function () {
            var e = this,
                a = e.config;
            if (
                    ...
                    layui.each(r, function (i, d) {
                        ...
                        return d
                            ? void (
                                  ...
                                  (e
                                      ? l && l < s && (a--, (c = s))
                                      : ((c = d.width || 0), /\d+%$/.test(c) ? ((c = Math.floor((parseFloat(c) / 100) * o)), c < s && (c = s)) : c || ((d.width = c = 0), a++)),
                                  d.hide && (c = 0),
                                  (n += c))
                              )
                            : void r.splice(i, 1);
        ...
        (F.prototype.loading = function (e) {
            ...
            a.loading &&
                (e
                    ? (i.layInit && i.layInit.remove(), delete i.layInit, i.layBox.find(g).remove())
                    : ((i.layInit = t(['<div class="layui-table-init">', '<i class="layui-icon layui-icon-loading layui-icon"></i>', "</div>"].join(""))),
            ...
            a.elem.on("click", 'input[name="layTableCheckbox"]+', function () {
                ...
                a.elem.on("click", 'input[lay-type="layTableRadio"]+', function () {
                    ...
                    layui.each(l, function (e, t) {
                        ...
                        layui.event.call(this, u, "radio(" + p + ")", v.call(this, { checked: i }));
                }),
                a.layBody
...
layui.define(["layer", "form"], function (t) {
    ...
    var e = layui.$,
        ...
        c = function () {
            var t = this;
            (t.index = 0),
                (t.config = { tool: ["strong", "italic", "underline", "del", "|", "left", "center", "right", "|", "link", "unlink", "face", "image"], hideTool: [], height: 280 });
        };
