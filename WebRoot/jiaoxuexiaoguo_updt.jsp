...
<div style="padding: 10px" class="admin-content">
    ...
    <%return;
     ...
     HashMap mmm = new CommDAO().getmap(request.getParameter("id"), "jiaoxuexiaoguo");
     %>
    ...
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">编辑教学效果:</div>
            <div class="panel-body">
                <form action="jiaoxuexiaoguo.jsp?a=update" method="post" name="form1" id="form1">
                    <!-- form 标签开始 -->

                    <div class="form-group">
                        <div class="row">
                            <label style="text-align: right" class="col-sm-2 hiddex-xs">效果分<span style="color: red">*</span></label>
                            <div class="col-sm-10">
                                <input
                                    type="number"
                                    class="form-control"
                                    ...
                                    data-msg-required="请填写效果分"
                                    number="true"
                                    data-msg-number="输入一个有效数字"
                                    id="xiaoguofen"
                                    name="xiaoguofen"
                                    value="<%= Info.html(mmm.get("xiaoguofen")) %>"
                                />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <select
                                    class="form-control class_jiaoshi20"
 ...
 <% for (Map m : select) { %>
                                ...
                                <script>
                                    $(".class_jiaoshi20").val($(".class_jiaoshi20").attr("data-value"));
                                </script>
                            </div>
                        </div>
                    </div>
