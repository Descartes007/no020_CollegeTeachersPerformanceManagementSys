...
<div style="padding: 10px" class="admin-content">
    ...
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">添加年度绩效:</div>
            <div class="panel-body">
                <form action="niandujixiao.jsp?a=insert" method="post" name="form1" id="form1">
                    <!-- form 标签开始 -->
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <div class="class_kaohe9" data-value="">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <select
                                    class="form-control class_jiaoshi10"
                                    data-value=""
