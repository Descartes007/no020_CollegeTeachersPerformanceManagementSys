...
<div style="padding: 10px" class="admin-content">
            ...
            <div class="pa10 bg-warning">
                <form class="form-inline" id="formSearch" action="?">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control class_kecheng29" data-value="<%= request.getParameter("kecheng") !=null ? request.getParameter("kecheng") : "" %>" id="kecheng" name="kecheng">
 ...
 <% for (Map m : select) { %>
                        ...
                        <script>
                            $(".class_kecheng29").val($(".class_kecheng29").attr("data-value"));
                        </script>
                    </div>
                ...
                <table width="100%" border="1" class="table table-list table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr id="<%= map.get("id") %>" pid="">
                            ...
                            <td><% Map mapkecheng8 = new CommDAO().find("SELECT kechengming,id FROM kecheng where id='" + map.get("kecheng") + "'"); %>
<%= mapkecheng8.get("kechengming") %></td>
