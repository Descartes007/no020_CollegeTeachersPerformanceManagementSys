...
<div style="padding: 10px" class="admin-content">
    ...
    <%return;
     ...
     HashMap mmm = new CommDAO().getmap(request.getParameter("id"), "niandujixiao");
     %>
    ...
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">编辑年度绩效:</div>
            <div class="panel-body">
                <form action="niandujixiao.jsp?a=update" method="post" name="form1" id="form1">
                    <!-- form 标签开始 -->
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <div class="class_kaohe11" data-value="<%= Info.html(mmm.get("kaohe")) %>">
                                ...
                                <script>
                                    $(".class_kaohe11 :radio[value='<%= Info.html(mmm.get("kaohe")) %>']").prop("checked", true);
                                </script>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <select
                                    class="form-control class_jiaoshi12"
 ...
 <% for (Map m : select) { %>
                                ...
                                <script>
                                    $(".class_jiaoshi12").val($(".class_jiaoshi12").attr("data-value"));
                                </script>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            <label style="text-align: right" class="col-sm-2 hiddex-xs">年份</label>
                            <div class="col-sm-10">
                                <input
                                    type="text"
                                    class="form-control"
